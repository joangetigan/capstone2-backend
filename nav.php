...
<div class="container">
    <button class="openbtn hidebtn">Browse Titles</button>&nbsp&nbsp&nbsp&nbsp&nbsp
    <div id="mySidenav" class="sidenav">
        <button class="closebtn">&times;</button>
        <h3>BOOK<br>MUSKETEERS</h3>
        <form method="POST" action="browse.php">
    ...
    <div class="dropdown hidebtn">
        <?php 
        if(!isset($_SESSION['is_logged_in'])) {
            echo "<a class='dropdown-toggle' href='#' data-toggle='dropdown'><button class='hidebtn'><span class='glyphicon glyphicon-log-in'></span>&nbsp&nbsp&nbsp Login</button></a>
                <div class='dropdown-menu'>
                    <form method='POST'>
                        <ul class='form-login'>
                            <li>
            ...
            echo "
                <a href='memberPage.php' class='hidebtn'><i class='fa fa-bookmark-o fa-lg' aria-hidden='true'></i>&nbsp&nbspSaved</a>&nbsp&nbsp&nbsp&nbsp&nbsp
                <span class='dropdown-toggle hidebtn' href='#' data-toggle='dropdown'>
                    <i class='fa fa-user-circle-o fa-2x' aria-hidden='true'></i>&nbsp
                    <i class='fa fa-angle-down' aria-hidden='true'></i>
                </span>
                <div class='dropdown-menu'>
